...
public class AccountServiceTest {
	...
	private static final String MOCK_DATA_ARRAY_THREE = "{\"firstName\":\"Jack\",\"lastName\":\"Doe\",\"accountNumber\":1299}";
	...
	public void getCountForFirstNamesInAccountWhenZeroOccurances() {
		...
		assertEquals(0, repo.getCountForFirstNames("Charlotte"));
	...
	public void getCountForFirstNamesInAccountWhenOne() {
		repo.createAccount(MOCK_DATA_ARRAY_ONE);
		repo.createAccount(MOCK_DATA_ARRAY_TWO);
		assertEquals(1, repo.getCountForFirstNames("Jack"));
	...
	public void getCountForFirstNamesInAccountWhenMult() {
		...
		assertEquals(2, repo.getCountForFirstNames("Jack"));
